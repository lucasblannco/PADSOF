...
public class Comic extends ProductoVenta {
	...
	public Comic(String nombre, String descripcion, String imagenRuta, double precioOficial, int stockDisponible, int numeroPaginas, String editorial, int añoPublicacion) {
